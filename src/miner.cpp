...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx)
{
    ...
    // Aib: CHAIN_ID and BLOCK_VERSION_AUXPOW bits are reserved for aib merged mining
    // Aib: and can safely be OR'd into the block version without overwriting BIP9 deployment
    // Aib: bits. BIP9 deployments on Aib can use any other bits
