...
/** Added nFees as input to merge with AIB GetBlockValue function*/
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, CAmount nFees);
/** Overload function added to be compatible with original GetBlockSubsidy call*/
...
// TODO: AIB MERGE for copay wallet operations
