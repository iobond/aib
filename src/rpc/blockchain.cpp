...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    // TODO: AIB Merge Recheck Normal Auxpow #004
    if (block.IsAuxPow()) {
        ...
        //TxToJSON((const CTransaction&)(*block.auxpow), uint256(), coinbasetx);
...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    // TODO: AIB Merge Recheck Softfork
