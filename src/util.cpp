...
const char * const BITCOIN_CONF_FILENAME = "aib.conf";
const char * const BITCOIN_PID_FILENAME = "aib.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Aib
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Aib
    // Mac: ~/Library/Application Support/Aib
    // Unix: ~/.aib
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aib";
#else
    // Unix
    return pathRet / ".aib";
#endif
