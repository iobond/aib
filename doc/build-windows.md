...
Building on Ubuntu Xenial 16.04 is known to be broken, see extensive discussion in issue [8732](https://github.com/aib/aib/issues/8732).
...
to work around issues with mingw-w64. See issue [8732](https://github.com/aib/aib/issues/8732) for more information.
```
...
way. This will install to `c:\workspace\aib`, for example:

    make install DESTDIR=/mnt/c/workspace/aib
