Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/aib/files/Bitcoin/aib-0.7.0/

We recommend that everybody running prior versions of aibd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/aib/aib/tarball/v0.7.0  # .tar.gz
  https://github.com/aib/aib/zipball/v0.7.0  # .zip
...
Core aib handling and blockchain database
...
* Ensure a changed aib unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for aib-qt.exe
* (Windows only): add meta-data to aib-qt.exe (e.g. description)
...
* Bash programmable completion for aibd(1)
