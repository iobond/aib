...
http://sourceforge.net/projects/aib/files/Bitcoin/aib-0.5.3/
...
http://gitorious.org/aib/aibd-stable/archive-tarball/v0.5.3#.tar.gz
...
Handle invalid Bitcoin URIs using "aib://" instead of "aib:".
Several shutdown issues have been fixed.
Revert to "global progress indication", as starting from zero every time was considered too confusing for many users.
Check that keys stored in the wallet are valid at startup, and if not, report corruption.
Enable accessible widgets on Windows, so that people with screen readers such as NVDA can make sense of it.
Various build fixes.
If no password is specified to aibd, recommend a secure password.
