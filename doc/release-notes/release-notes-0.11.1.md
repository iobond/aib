Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://aib.org/bin/aib-core-0.11.1/>
...
(see https://github.com/aib/aib/pull/6795).
...
one was randomly violated by all deployed aib software prior to
...
http://fc15.ifca.ai/preproceedings/aib/paper_9.pdf
...
(see https://github.com/aib/aib/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libaibconsensus: avoid a crash in multi-threaded environments
