Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://aib.org/bin/aib-core-0.11.0/>
...
For example, add the following to `aib.conf`:
...
related to the blockchain in the aib system: the raw blocks as received over 
...
For an example script see [aib-submittx](https://github.com/laanwj/aib-submittx).
...
- #5334 `cf87536` libaibconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new aib-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add aib logo to about screen
...
- #5809 `46bfbe7` Add aib-cli man page
...
- #5849 `41259ca` contrib/init/aibd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for aib-tx)
