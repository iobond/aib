...
allowing somebody to distribute a Bitcoin-Qt.app or aib-qt-setup.exe with a valid
...
that the aib-qt.exe file inside the installer had not been tampered with.
